...
echo "PTM ENVIRONMENT IS: $PTM_ENV";
...
# echo "invalid tag, don't use special characters: $TAG";
# TAG="";
#fi;
...
local targets=$(echo $TARGETS | tr ";" "\n")
 for TARGET in $targets
  ...
  do
    ...
    echo "export PTM_ENV=\"$PTM_ENV\"" >> $requestFile;
...
startTest () {
 ...
 local targetsList=`echo $TARGETS | tr ";" "_"`
 TEST_ID="$date.$targetsList.$TAG";
 export TEST_ID="$TEST_ID"; 
...
cancelTest () {
 ...
 mv -v "$TEST_DIR" $DIR/../../artifacts/$PTM_ENV/tests/cancelled
