...
startHeapDumpCapture () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".start.heapDumpCapture.reg";
...
startThreadDumpCapture () {
  ...
  do
    USER=`$DIR/../../config/getProperty.sh $TARGET "$tier\.user"`
    SERVER=`$DIR/../../config/getProperty.sh $TARGET "$tier\.server"`
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".start.threadDumpCapture.reg";
    echo "processing TD	$tier $USER $SERVER";
    echo "cd ../threadDumpCapture" >> $requestFile;
    
 if [ "$PTM_ENV" != "" ]
then
    threadDumpsDir="artifacts/$PTM_ENV/threadDumps/"$TARGET"-"$tier"/"$date"-"$TAG;
else
...
stopThreadDumpCapture () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".stop.threadDumpCapture.reg";
    echo "cd ../threadDumpCapture" > $requestFile;
    echo "export TEST_ID=\"$TEST_ID\"" >> $requestFile;
...
startShadowtail () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".start.shadowtail.reg";
...
stopShadowtail () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".stop.shadowtail.reg";
    echo "cd ../shadowtail" > $requestFile;
    echo "export TEST_ID=\"$TEST_ID\"" >> $requestFile;
...
restartServer () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".restart.tomcat.reg";
...
restartServerProfiling () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".restart.tomcat.profiling.reg";
...
startCpuProfiling () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".start.cpu.sampling.reg";
...
switchToMemoryProfiling () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".switchToMemoryProfiling.reg";
...
captureMemorySnapshotStopProfiling () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".captureMemorySnapshotStop.reg";
...
cancelShadowtail () {
  ...
  do
    ...
    requestFile="work/requests/"$SERVER"."$USER"."$TARGET"."$tier"."$TAG"."$date".cancel.shadowtail.reg";
    echo "cd ../shadowtail" > $requestFile;
...
then
 ...
 echo "test.target=$TARGET" >> $TEST_CONFIG;
...
if [ "$PTM_ENV" != "" ]
then
	mv "$TEST_DIR" $DIR/../../artifacts/$PTM_ENV/tests/cancelled
else
	mv "$TEST_DIR" $DIR/../../artifacts/tests/cancelled
fi
