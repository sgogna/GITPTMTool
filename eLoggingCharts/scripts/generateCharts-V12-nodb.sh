...
java -Xmx1000M -DsrcTestName=V12_$1_$2_"T2" -DsrcFile=$T2_LOG_PATTERN$1".log" -Dinterval=60000 -DstatisticsCSV=true -DstartDate="$3" -DendDate="$4" -DaggregationTypes="$AGG_TYPES" -DexcludedEventTypes=".*CMD.*|.*DB.*" -DexcludedEventNames="" -cp eLoggingParser-1.0.jar com.eb2.elogging.ChartsGenerator
